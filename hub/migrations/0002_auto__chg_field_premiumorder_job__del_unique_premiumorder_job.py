...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PremiumOrder', fields ['job']
        db.delete_unique('premium_orders', ['job_id'])


        # Changing field 'PremiumOrder.job'
        db.alter_column('premium_orders', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hub.Job'], null=True))

    def backwards(self, orm):

        # Changing field 'PremiumOrder.job'
        db.alter_column('premium_orders', 'job_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['hub.Job'], unique=True, null=True))
        # Adding unique constraint on 'PremiumOrder', fields ['job']
        db.create_unique('premium_orders', ['job_id'])
